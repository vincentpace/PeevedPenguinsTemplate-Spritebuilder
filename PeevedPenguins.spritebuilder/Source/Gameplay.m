...
- (void)didLoadFromCCB {
    ...
    // add this line to didLoadFromCCB to deactivate collisions for this invisible node:
    _mouseJointNode.physicsBody.collisionMask = @[];
}

// called on every touch in this scene
// We are going to replace the complete touchBegan implementation. This is the new one:
